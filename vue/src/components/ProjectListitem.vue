...
<div  class="flex flex-col py-4 px-6 shadow-md bg-white hover:bg-gray-50 h-[470px]" >
    ...
    <div class="flex items-center">
      <a :href="`/view/project/${project.slug}`"
      target="_blank"
      class="h-8 w-8 items-center justify-center rounded-full border border-transparent text-sm text-indigo-500 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
